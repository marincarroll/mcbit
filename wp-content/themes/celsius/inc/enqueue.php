...
function mcbit_blocks_enqueue_block_editor_assets() {
	...
	wp_enqueue_style(
   	...
   	//Text format example
    $tooltip_asset = require(MCBIT_BLOCKS_DIR . 'build/tooltip/index.asset.php');
	wp_enqueue_script(
        'mcbit-tooltip', 
        MCBIT_BLOCKS_URL. 'build/tooltip/index.js', 
        $tooltip_asset['dependencies'],
        $tooltip_asset['version']
    );

	//Global attribute example
    $thingy_asset = require(MCBIT_BLOCKS_DIR  . 'build/thingy/index.asset.php');
	wp_enqueue_script(
        'mcbit-thingy-editor', 
        MCBIT_BLOCKS_URL. 'build/thingy/index.js', 
